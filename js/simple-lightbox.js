...
$.fn.simpleLightbox = function( options )
{
	...
	var touchDevice	= ( 'ontouchstart' in window ),
		...
		image = $('<div>').addClass('sl-image').attr("id","Imgsrc"),
		wrapper = $('<div>').addClass('sl-wrapper').addClass(options.className).attr("id","lightImg"),
	...
	//图片关闭
	this.imgCloseFun = function(){
        //带点击图片区域也关闭
        
		if (options.imgClose) {  
		  var  flag = options.imgTouchFlag;     
           var $selector = $('#Imgsrc'); //获取承载图片的div； 
